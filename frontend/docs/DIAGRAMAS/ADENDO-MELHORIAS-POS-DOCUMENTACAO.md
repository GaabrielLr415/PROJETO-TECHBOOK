...
## 25. CORS, Execucao, README e Dados de Teste

1. Nome: Melhorias tecnicas de execucao e manutencao.
2. Objetivo: Facilitar instalacao, execucao, testes e apresentacao.
...
5. Fluxo: README explica a estrutura; scripts do backend ajudam a iniciar a API e rodar testes; scripts SQL preparam ou ajustam o banco.
...
11. DER: documentado em `frontend/docs/DIAGRAMAS/MER-DER-TECHBOOK.md`.
...
15. Evidencias: `README.md`, `backend/run-backend.ps1`, `backend/run-tests.ps1`, `database/techbook.sql`, `CorsConfig.java`, `DataInitializer.java`.
